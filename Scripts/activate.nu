...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Minec\PycharmProjects\dissTopicModel\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Minec\PycharmProjects\dissTopicModel\venv\Scripts\deactivate.nu'
